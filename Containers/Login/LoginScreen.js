...
import { View,StyleSheet, ImageBackground,Image,Text,KeyboardAvoidingView,
    TouchableWithoutFeedback,Platform,Keyboard,TextInput,Button,SafeAreaView,TouchableOpacity} from "react-native";
                        ...
                        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                            <View>
                                ...
                                <View style={styles.inner2}>
                                    <TextInput placeholder="+225" keyboardType="numeric" style={styles.TextInput}/>
                                ...
                                onPress = {()=>this.props.navigation.navigate('Destination')} >
                                    <Text style={styles.TextS} >SE CONNECTER</Text>

                                </TouchableOpacity>
                                <Text style={styles.text1}> Pas de compte ?</Text><Text style={styles.text2} onPress={() => this.props.navigation.navigate('Signup') }>S'inscrire</Text>
                            </View>
